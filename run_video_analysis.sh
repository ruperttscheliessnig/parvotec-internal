#!/bin/bash
# Comprehensive Video Analysis Launcher
# Handles path with spaces for ASGCT 2026 MP4 analysis

cd "$HOME/workspace-active/parvotec/Machine learning for Rupert"

cat > analyze_videos.py << 'PYTHON_SCRIPT'
#!/usr/bin/env python3
"""
...
# Run the analysis
echo "🎬 Starting comprehensive video analysis..."
~/miniforge3/bin/python3 analyze_videos.py
